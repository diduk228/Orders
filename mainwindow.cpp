...
{
    ui->setupUi(this);
    QStringList headers = {"Кирпич", "Отвётка", "Бензопила"};
    setupModel(headers, "Товары");
    this->createUI();
    QImage image("C:\\Users\\danil\\Documents\\maket\\Goods\\кипич.jpg");//QImage's Constructor takes a file path
 ...
 * */
void MainWindow::setupModel(QStringList &headers, QString tableName = "Товыры")
{
